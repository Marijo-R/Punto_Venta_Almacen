        ...
        <div id="page-wrapper">
            <div class="header">
                <h1 class="page-header">
                    <b>ACTUALIZAR ORDEN DE COMPRA</b>
                </h1>
            </div>
            <div id="page-inner">
                <div class="row">
                                ...
                                <form class="col s12">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m2">
                                            ...
                                            <input type="varchar" class="form-control" id="subtotal" class="validate" placeholder="">
                                        </div>
                                        <div class="col s12 m2">
                                        ...
                                        <div class="col s12 m2">
                                            ...
                                            <input type="varchar" class="form-control" id="iva" class="validate" placeholder="">
                                        </div>
                                        <div class="col s12 m2">
                                            <label for="email" class="form-label">Retención</label>
                                            <input type="varchar" class="form-control" id="retencion" class="validate" placeholder="">
                                        </div>
                                        <div class="col s12 m2">
                                            <label for="email" class="form-label">Total</label>
                                            <input type="varchar" class="form-control" id="total" class="validate" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row">
