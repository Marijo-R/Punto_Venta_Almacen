                                ...
                                <form class="col s12">
                                    <div class="row">
                                        <div class="col s12 m6 ">
                                            ...
                                            <input type="varchar" class="form-control" id="codigo" class="validate" placeholder="Unidad de medida">
                                        </div>
                                        <div class="col s12 m6 ">
                                            <label for="codigo_alterno" class="form-label">Simbolo</label>
                                            <input type="varchar" class="form-control" id="codigo_alterno" class="validate" placeholder="Simbolo">
                                        </div>
                                    </div>
                                    <div class="row">
