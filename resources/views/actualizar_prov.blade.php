                        ...
                        <div class="card">
                            <div class="card-content">
                                <form class="col s12">
                                    ...
                                    <div id="fisico" style="display: block;"><label><strong>DATOS PERSONALES</strong></label></div>
                                    <div class="row fisico" style="display: block;">
                                        <div class="col s12 m4 ">
                                            <label for="nombre" class="form-label">Nombre</label>
                                            <input type="varchar" class="form-control" name="nombre" id="fisico" class="validate" placeholder="Nombre" value="Juan">
                                        </div>
                                        <div class="col s12 m4 ">
                                            <label for="apellido_ap" class="form-label">Primer apellido</label>
                                            <input type="varchar" class="form-control" id="apellido" class="validate" placeholder="Primero apellido" value="Reyes">
                                        </div>
                                        <div class="col s12 m4">
                                            <label for="segundo_ap" class="form-label">Segundo apellido</label>
                                            <input type="varchar" class="form-control" id="segundo_ap" class="validate" placeholder="Segundo apellido" value="Mendez">
                                        </div>
                                    </div>
                                    <div class="row fisico_cr" style="display: block;">
                                        <div class="col s12 m6">
                                            <label for="clave"> Clave Única de Registro de Población (CURP)</label>
                                            <input id="clave" class="form-control" type="varchar" class="validate" placeholder="0000000000000" value="REMJ061798MVZA7">
                                        </div>
                                        <div class="col s12 m6">
                                            <label for="alias" class="form-label">Registro Federal de Contribuyentes (RFC)</label>
                                            <input type="varchar" class="form-control" id="alias" class="validate" placeholder="00000000000000" value="REMJ061798A7">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m4">
                                            ...
                                            <input type="varchar" class="form-control" id="email" class="validate" placeholder="ejemplo@gmail.com" value="j.reyesM@gmail.com">
                                        </div>
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m4">
                                            ...
                                            <input id="tel" class="form-control" type="varchar" class="validate" placeholder="0000000000" value="2711348967">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m3">
                                            ...
                                            <input type="varchar" class="form-control" id="calle" class="validate" placeholder="Calle" value="Aguillon">
                                        </div>
                                        <div class="col s12 m3">
                                        ...
                                        <div class="col s12 m3">
                                            ...
                                            <input id="no_ext" class="form-control" type="varchar" class="validate" placeholder="00" value="21">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <label for="cod_pos" class="form-label">Código Postal (C.P.)</label>
                                            <input type="varchar" class="form-control" id="cod_pos" class="validate" placeholder="00000" value="94554">
                                        </div>
                                        <div class="col s12 m4">
                                            <label for="colonia">Colonia</label>
                                            <input type="varchar" id="colonia" class="form-control" class="validate" placeholder="" value="L.P">
                                        </div>
                                        <div class="col s12 m4">
                                            <label for="local">Localidad</label>
                                            <input type="varchar" id="local" class="form-control" class="validate" placeholder="" value="Córdoba">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <label for="ciudad" class="form-label">Ciudad</label>
                                            <input type="varchar" class="form-control" id="ciudad" class="validate" placeholder="" value="Córdoba">
                                        </div>
                                        <div class="col s12 m4">
                                            <label for="estado">Entidad Federativa (estado)</label>
                                            <input type="varchar" id="estado" class="form-control" class="validate" placeholder="" value="Veracruz">
                                        </div>
                                        <div class="col s12 m4">
                                            <label for="pais">País</label>
                                            <input type="varchar" id="pais" class="form-control" class="validate" placeholder="" value="México">
                                        </div>
                                    </div>
                                    <div class="row">
